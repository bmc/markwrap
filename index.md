...
Version 0.4.1 is available for Scala 2.9.0-1, 2.9.0, 2.8.1 and 2.8.0.
...
`project/build/` directory):
    ...
    val markwrap = "org.clapper" %% "markwrap" % "0.4.1"
...
enough to figure out what to do, on your own.
    ...
    libraryDependencies += "org.clapper" %% "markwrap" % "0.4.1",
